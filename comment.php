...
<title>Optimun Destro | Dashboard</title>
...
<body>
  <div class="container">
    <div id="mySidenav" class="sidenav">
      ...
      <a href="nav_post.php" class="active"><i></i> Post</a>
    ...
    <div id="main">
      ...
      <div class="breadcrumb">
        <?php echo 
      	"<a id='post' href='nav_post.php?page=topics&amp;'>Topics</a><t/> | <t/><a id='post1' href='nav_post.php?page=mypost&amp;'>My Post</a><t/> | <t/><a id='post2' href='nav_post.php?page=newpost&amp;'>New Post</a><t/> | <t/><a id='post3' href='comment.php?page=wcomment&amp;'>Comments</a><t/> | <t/><a id='post4' href='sslogout.php'> Logout </a> | <t/>";
        ?>
      ...
      <div class="thu col-md-12" style="margin-bottom: 10px">
        <h2> Topic: <?php if (isset($_SESSION['topic'])) {
        	echo $_SESSION['topic'];
        } ?></h2>
        <p style="text-align: center;">Content:<br/><marquee style="width: 20%" > <i><?php if (isset($_SESSION['content'])) {
          echo $_SESSION['content'];
        } ?></i></marquee></p>
        <div class="display col-md-12" style="margin-bottom: 10px">
          <div id="come" style="padding-bottom: 10px">
            <?php 
            error_reporting(0);
            $p = $_GET['page'];
